...
| PX-M0-02 | M0 | Add OU simulation and recovery validation fixtures | Codex | Review | PX-M0-01 | Simulation harness + correctness tests |
| PX-M0-03 | M0 | Root invariance and numerical stability checks | Codex | Review | PX-M0-01 | Invariance tests + precision checks |
| PX-M1-01 | M1 | Implement masked pairwise distances and NJ init | Codex | Review | PX-M0-01 | Distance builder + NJ topology init |
| PX-M1-02 | M1 | Optimize branch lengths on fixed topology | Codex | Review | PX-M1-01 | Branch-length optimizer |
| PX-M1-03 | M1 | Fit partition-specific `alpha_g` and `sigma_g^2` | Codex | Review | PX-M1-02 | Parameter refinement loop |
| PX-M2-01 | M2 | Implement directional message pass caches | Codex | Review | PX-M1-03 | Postorder/preorder cache infra |
| PX-M2-02 | M2 | Batch NNI scoring for all internal edges | Codex | Review | PX-M2-01 | GPU/torch batched scoring |
